...
extension Manga {
    ...
    static var manga1 = Manga(
        ...
        endDate: "2011-04-19T00:00:00Z",
        genres: [Genre(id: "1", genre: "Action"), Genre(id: "2", genre: "Adventure")],
        authors: [Author(id: "1", firstName: "Kentarou", role: "Story & Art", lastName: "Miura")],
    ...
    static var manga2 = Manga(
        ...
        authors: [Author(id: "2", firstName: "Eiichiro", role: "Story & Art", lastName: "Oda")],
        demographics: [Demographic(id: "1", demographic: "Shonen")],
    ...
    static var manga3 = Manga(
        ...
        endDate: "2010-06-11T00:00:00Z",
        genres: [Genre(id: "1", genre: "Action"), Genre(id: "4", genre: "Military"), Genre(id: "5", genre: "Adventure")],
        authors: [Author(id: "3", firstName: "Hiromu", role: "Story & Art", lastName: "Arakawa")],
        demographics: [Demographic(id: "1", demographic: "Shonen")],
